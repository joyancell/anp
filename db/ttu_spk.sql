...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Jun 2021 pada 15.35
...
('C1', 'WC Umum', 1.22222222222222, 0.7273253062726767),
('C2', 'Akses Jalan', 10.11111111111111, 0.22116480011216966),
('C3', 'Akomodasi', 19, 0.05150989361515634);
...
INSERT INTO `data_wisata` (`id_wisata`, `nama_wisata`, `foto_wisata`, `alamat`, `hasil_akhir`, `lat`, `lng`) VALUES
('A001', 'wisata contoh', '1623487962.png', 'dsdsd sdsd', NULL, '', ''),
('A002', 'sdsdsddsd', '513.jpg', 'dsdsd sdsd', NULL, '', ''),
('A003', 'ffaf', '123.png', 'dsdsd sdsd', NULL, '', '');
...
(2, 'nama admin', 'atasan', 'admin', '827ccb0eea8a706c4c34a16891f84e7b');
...
--
ALTER TABLE `nilai_awal`
  MODIFY `id_nilai_awal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT untuk tabel `nilai_awal_detail`
--
ALTER TABLE `nilai_awal_detail`
  MODIFY `id_nilai_awal_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
